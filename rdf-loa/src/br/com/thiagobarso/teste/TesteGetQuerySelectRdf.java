...
public class TesteGetQuerySelectRdf {
	...
	public static void main(String[] args) {
		...
		ArrayList<String> colunasPertencentesATabela = getColunas(t,root);
		search.getQuerySelectRdf(t, root, colunasPertencentesATabela);
		System.gc();				
	}

	private static ArrayList<String> getColunas(String t, String root) {
		ArrayList<String> colunas = new ArrayList<String>();
		colunas.add("loa:identificador");
		colunas.add("loa:dataUltimaAtualizacao");
		return colunas;
	}
